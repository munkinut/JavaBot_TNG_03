 ...
 */
public class JBInvalidServerException extends Exception {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = 3121686020179780748L;

	/**
     * Creates a new instance of <code>JBInvalidPortException</code> without detail message.
     */
    public JBInvalidServerException() {
    }
     ...
     */
    public JBInvalidServerException(String msg) {
        super(msg);
    }
     ...
     */
    public JBInvalidServerException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
