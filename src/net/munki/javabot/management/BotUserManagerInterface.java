...
public interface BotUserManagerInterface {
     ...
     */
    boolean canOp(ChannelUser channelUser, Channel myChannel);
     ...
     */
    boolean canDeop(ChannelUser channelUser, Channel myChannel);
     ...
     */
    boolean canVoice(ChannelUser channelUser, Channel myChannel);
     ...
     */
    boolean canDevoice(ChannelUser channelUser, Channel myChannel);
