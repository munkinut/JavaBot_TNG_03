 ...
 * ReplyEvent.java
 *
 * Generated in response to a numeric reply message from the server
 *
 ...
 */
public class IRCReplyEvent extends IRCEvent {

    /** Creates a new MessageEvent.
     * @param source The source of the event
     * @param actionCommand An object representing the action command
     */
    public IRCReplyEvent(Object source, Object actionCommand) {
